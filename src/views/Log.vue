...
export default {
  ...
  methods: {
    ...mapMutations(['setHeadLeftComponent']),

    // 获取日志详细信息
    getDailylog () {
      setTimeout(() => {
        // 计算canvas高度
        this.canvasHeight = 180 + 80 * 3
        ...
        // 天气
        this.tabHead(1120, 40, 1, 1, 0, 40, this.empty)
        // 地块，作物
        this.tabHead(70, 110, 1, 2, 0, 80, this.data1)
        // 播种，移栽
        this.tabHead(140, 40, 1, 2, 140, 80, this.data2)
        // 施肥
        this.tabHead(210, 40, 1, 1, 420, 80, this.data3)
        // 病虫害
        this.tabHead(210, 40, 1, 1, 630, 80, this.data4)
        // 除草后6个
        this.tabHead(70, 110, 1, 4, 840, 80, this.data5)
        // 品种后的所有
        this.tabHead(70, 70, 1, 10, 140, 120, this.data6)

        this.$set(this, 'dailylog', [
          ['种植区1', '苹果', '溏心', '土载', '', '', '氨肥', '0.5', '混合', '', '', '', '31', '500', '1500', '苏锐佳'],
          ['种植区1', '草莓', '白', '水载', '', '', '氨肥', '0.5', '混合', '', '', '', '15', '100', '230', '苏锐佳']
        ])
        this.tabHead(
          70,
          80,
          this.dailylog.length,
          16,
          0,
          190,
          this.dailylog
        ...
        // 获取时间，天气，操作人，期数
        this.$set(this, 'daily_record', ['2020-07-28', '晴', '苏锐佳', '5'])
        this.getMessage()
    ...
    // 循环canvans
    tabHead (width, height, list, row, beginX, beginY, data) {
      // 用来画表格的函数
      var c = document.getElementById('canvas')
      var cxt = c.getContext('2d')
      cxt.font = '16px Arial'
